...
namespace FargoLegacy.Content.Projectiles.Deathrays
{
    public abstract class BaseDeathrayLegacy : ModProjectile
    {
        ...
        protected BaseDeathrayLegacy(float maxTime, string texture, float transparency = 0f, float hitboxModifier = 1f)
        {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D20 = ModContent.Request<Texture2D>($"FargoLegacy/Content/Projectiles/Deathrays/{texture}2" + "Legacy", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
