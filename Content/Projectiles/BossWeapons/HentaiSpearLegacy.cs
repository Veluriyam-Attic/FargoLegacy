...
{
    public class HentaiSpearLegacy : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int byUUID = FargoSoulsUtilLegacy.GetByUUIDReal(Projectile.owner, (int)Projectile.ai[0], ModContent.ProjectileType<DashLegacy>());
            if (byUUID != -1)
            {
    ...
    public static class FargoSoulsUtilLegacy
    {
