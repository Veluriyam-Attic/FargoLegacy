...
namespace FargoLegacy.Content.Projectiles
{
    public class PhantasmalSphereLegacy : ModProjectile
    {
        ...
        {
            Texture2D glow = ModContent.Request<Texture2D>("FargoLegacy/Content/Projectiles/MutantBoss/MutantSphereGlowLegacy", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
